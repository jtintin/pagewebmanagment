            ...
            <form action="{{route('admin.post.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="car-body">
                        ...
                        <input type="text" class="form-control" name="title" placeholder="Name" value="{{old('title')}}" required maxlength="190">
                        </div>
                        <div class="mb-3">
                        <label for="content">Contenido:</label>
                        <input type="textarea" class="form-control" name="content" placeholder="Descripción" value="{{old('content')}}" required></textarea>
                        </div>
